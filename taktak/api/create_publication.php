...
if(isset($postdata) && !empty($postdata))
{
	...
	$sql = "INSERT INTO `taktak`.`Colis`(nomPrenomDest,telDest,adresseDest, numColis, libelleColis, poids, etat, prixColis, fraisLivraison) VALUES ('$nomPrenomDest', '$telDest', '$adresseDest', $numColis, '$libelleColis','$poids', '$etat', '$prixColis','$fraisLivraison')";
	if($db->query($sql))
	{
		http_response_code(201);
		$publication = [
		'numColis' => mysqli_insert_id($db),'nomPrenomDest' => $nomPrenomDest,
		'telDest' => $telDest,
        'adresseDest'=> $adresseDest, 
        'numColis'=> $numColis, 
        'libelleColis'=> $libelleColis, 
        'poids'=> $poids, 
        'etat'=> $etat, 
        'prixColis'=> $prixColis, 
